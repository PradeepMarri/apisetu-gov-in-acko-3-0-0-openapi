# Acko General Insurance Limited MCP Server

This MCP (Model Content Protocol) server provides access to Acko General Insurance Limited API functionality through HTTP, HTTPS, and STDIO transport modes.
